...
"""todoapp.py: IS 211 Assignment 11."""
...
# Initialize the global todos list
todos = []


def load_saved_todos():
    """
    Function to load saved todos from todos.json,
...
def index():
    """
    Function to render the template and pass todos, errors, and alerts.
    Errors and alerts are stored in the session, use session.pop() to
    get the values and clear them from the session.
    """
...
def submit():
    """
    Function to run on submit. Validates data and either adds to-do to
    the to-dos list, or returns error messages.
    """
    def validate():
